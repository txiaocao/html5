...
var xiaok = (function () {
    ...
    */
    xiaok.prototype.isTrueOrFalse = function (number) {
    ...
    * @param Max
    */
    xiaok.prototype.random = function (Min, Max) {
        var Range = Max - Min;
    ...
    * @param num
    */
    xiaok.prototype.randomArray = function (arr, num) {
...
var role = (function () {
    ...
    // 摸卡
    role.prototype.getCard = function () {
    ...
    role.prototype.setCard = function (card) {
        this.card = card;
    };
    ...
    role.prototype.setHP = function (hp) {
        this.hp += hp;
    };
    return role;
})();
...
*/
var card = (function () {
    function card(no, name, type, hp, tips) {
        this.no = no;
        this.name = name;
        this.type = type;
        this.hp = hp;
...
var page5 = (function () {
    ...
    page5.prototype.getRound = function () {
        return this.round;
    };
    page5.prototype.getBugCard = function () {
        return this.bugCard.shift();
    };

    page5.prototype.getPlayerCard = function () {
        return this.player.getCard();
    };
    page5.prototype.getComputerCard = function () {
        return this.computer.getCard();
    };

    // 卡片初始化
    page5.prototype.initCard = function () {
        var tools = new xiaok();
